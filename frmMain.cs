...
namespace WktViewer
{
    public partial class frmMain : Form
    {
        ...
        public frmMain(bool isGeography, string content)
        {
            InitializeComponent();
        ...
        {
            OpenGisGeometryType geometryType = this.GetGeometryType(geometry);
        ...
        {
            OpenGisGeometryType geometryType = this.GetGeometryType(geography);
        ...
        private OpenGisGeometryType GetGeometryType(SqlGeography geography)
        {
        ...
        private OpenGisGeometryType GetGeometryType(SqlGeometry geometry)
        {
